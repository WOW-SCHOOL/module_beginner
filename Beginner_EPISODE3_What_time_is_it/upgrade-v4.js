...
const WOW_V4_HELPERS={
  1:{title:"Лёгкая подсказка",html:"Сначала определи часы, затем минуты. Для <b>past</b> считай минуты после часа, для <b>to</b> — минуты до следующего часа."},
  2:{title:"Простое правило",html:"<b>a quarter past</b> = 15 минут после часа, <b>half past</b> = 30 минут после часа, <b>a quarter to</b> = 15 минут до следующего часа."},
  4:{title:"Лёгкая подсказка",html:"В вопросе о времени сначала собери устойчивую часть <b>What time…?</b>, затем продолжи фразу по смыслу."},
  6:{title:"Лёгкая подсказка",html:"Слушай прежде всего число и слова <b>past / to / o’clock</b>. Они помогают быстро восстановить время."}
};
