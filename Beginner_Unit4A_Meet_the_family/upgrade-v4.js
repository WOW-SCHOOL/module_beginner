...
const WOW_V4_HELPERS={
  1:{title:"Лёгкая подсказка",html:"Сначала определи отношение человека к семье: mother, father, sister, brother, husband, wife, daughter или son."},
  2:{title:"Лёгкая подсказка",html:"Слушай целевой звук целиком в слове. Не ориентируйся только на букву — в английском написание и звук могут отличаться."},
  3:{title:"Простое правило",html:"Possessive adjective стоит перед существительным: <b>my sister</b>. Possessive ’s показывает владельца: <b>Jerry’s wife</b>."},
  4:{title:"Лёгкая подсказка",html:"Сначала найди семейную связь, затем соединяй людей. Используй уже подтверждённые пары как опору."}
};
const WOW_V4_TRANSCRIPT={"screen": 6, "section": "listening", "kind": "scripts", "roles": ["Friend", "Family member"]};
