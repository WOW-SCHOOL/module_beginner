...
const WOW_V4_HELPERS={
  1:{title:"Лёгкая подсказка",html:"Сначала назови предмет: cap, scarf, shirt, key ring, mug, plate, teddy bear или T-shirt."},
  2:{title:"Простое правило",html:"<b>this / these</b> — близко; <b>that / those</b> — дальше. Singular: this/that. Plural: these/those."},
  3:{title:"Лёгкая подсказка",html:"В цене сначала улови pounds, затем число после него. Не выбирай вариант только по первому числу."},
  4:{title:"Лёгкая подсказка",html:"В магазине определи цель реплики: спросить предмет, узнать цену, выбрать количество или завершить покупку."}
};
const WOW_V4_TRANSCRIPT={"screen": 7, "section": "listening", "kind": "scripts", "roles": ["Customer", "Shop assistant"]};
