...
const WOW_V4_HELPERS={
  1:{title:"Лёгкая подсказка",html:"Слушай знакомые breakfast words и ключевые ответы yes / no. Не пытайся перевести весь диалог сразу."},
  2:{title:"Лёгкая подсказка",html:"Сначала определи: food или drink. Затем выбери точное английское слово."},
  3:{title:"Лёгкая подсказка",html:"Смотри на тип продукта и привычное место в завтраке; переносить карточки можно по одной."},
  4:{title:"Простое правило",html:"С <b>I / you / we / they</b> используй base verb. С <b>he / she / it</b> обычно добавляется <b>-s / -es</b>."}
};
const WOW_V4_TRANSCRIPT={"screen": 7, "section": "listen2", "kind": "scripts", "roles": ["Interviewer", "Guest"]};
