...
const WOW_V4_HELPERS={
  1:{title:"Лёгкая подсказка",html:"Сначала определи travel context: airport, plane, luggage или document. Затем выбирай слово."},
  2:{title:"Лёгкая подсказка",html:"Слушай ключевое airport word целиком и сравни его с картинкой / ситуацией, а не только с переводом."},
  3:{title:"Лёгкая подсказка",html:"Перед сортировкой назови категорию: document, luggage, airport place или in-flight item."},
  4:{title:"Простое правило",html:"В present simple сначала найди подлежащее, затем verb form. В вопросах и отрицаниях следи за <b>do / does</b>."}
};
const WOW_V4_TRANSCRIPT={"screen": 7, "section": "listen2", "kind": "scripts", "roles": ["Friend", "Traveller"]};
