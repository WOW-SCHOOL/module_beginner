(() => {
  ...
  style.textContent = `
    ...
    .wow-pin-gate:after{width:520px;height:520px;right:-210px;top:-230px;background:radial-gradient(circle,rgba(24,191,174,.20),transparent 70%)}
    ...
    .wow-pin-btn{width:100%;height:58px;margin-top:14px;border:0;border-radius:18px;background:linear-gradient(145deg,#18bfae,#2b8bf2);color:#fff;font:inherit;font-size:18px;font-weight:950;cursor:pointer;box-shadow:inset 0 2px 0 rgba(255,255,255,.25),0 12px 24px rgba(36,145,214,.20);transition:.15s}
