...
const WOW_V4_HELPERS={
  1:{title:"Лёгкая подсказка",html:"В первом прослушивании поймай общую характеристику машины: colour, size, age, price или opinion."},
  2:{title:"Лёгкая подсказка",html:"Сначала реши, описывается цвет или качество машины. Затем выбирай точное adjective."},
  3:{title:"Лёгкая подсказка",html:"Перед переносом карточки назови её категорию про себя. Это помогает не сортировать по случайной ассоциации."},
  4:{title:"Простое правило",html:"В английском adjective обычно стоит <b>перед существительным</b>: a small car; или после <b>be</b>: the car is small."}
};
const WOW_V4_TRANSCRIPT={"screen": 7, "section": "listen2", "kind": "scripts", "roles": ["Buyer", "Friend"]};
