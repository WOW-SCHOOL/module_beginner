...
- Существующие student-facing helpers / правила сохранены; дублирующие подсказки не добавлялись.
...
- Существующие четыре QA-shortcut сохранены и не дублировались.
...
- Текущий folder / GitHub path `Beginner_Unit6B_Good_morning_goodnight`.
