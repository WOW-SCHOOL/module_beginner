...
const WOW_V4_HELPERS={
  1:{title:"Лёгкая подсказка",html:"Сначала определи тему слова: small things, souvenirs, family или adjectives. Это быстрее сузит выбор."},
  2:{title:"Простое правило",html:"Проверь число и расстояние: <b>this / that</b> — singular, <b>these / those</b> — plural. Для possessives сначала найди владельца."},
  3:{title:"Лёгкая подсказка",html:"Перед сортировкой назови категорию про себя: object, souvenir, family или adjective — затем переноси карточку."},
  4:{title:"Лёгкая подсказка",html:"Сначала найди основу предложения, затем поставь demonstrative / possessive и остальные слова в естественный английский порядок."}
};
